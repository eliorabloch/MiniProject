...
namespace BL
{
    public interface IBL
    {
        ...
        bool SendOrder(Host h, Order o,HostingUnit hu);//A function that checks whether an order can be sent to a customer. Only if the client has signed a host bank authorization form can he send an order.
